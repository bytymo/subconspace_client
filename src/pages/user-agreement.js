...
const UserAgreement = () => {
  ...
  return (
    <div className='h-100'>
      ...
      <Divider />
      <form>
        {/* <div class="col-md-4 form-floating text-dark">
          <input type="text" class="form-control" name='firstName' id="firstName" value={firstName} onChange={onChange} placeholder='First Name' required  />
          <label for="firstName" className='mx-2'>First Name (dark text)</label>
        </div>
        <div class="col-md-4 form-floating">
          <input type="text" class="form-control" name='lastName' id="lastName" value={lastName} onChange={onChange} placeholder='Last Name' required />
          <label for="lastName">Last Name (Default lighter text)</label>
        </div>
        <div class="col-md-4 form-floating">
          <input type="email" class="form-control" name='email' id="lastName" value={email.length ? email : null} onChange={onChange} placeholder='Email Address' required />
        ...
        <div class="col-12">
          <div class="form-check text-start">
            <input class="form-check-input" type="checkbox" value="" id="termsConditionsCheckbox" checked={isChecked} onChange={handleCheckbox} required />
            <label class="form-check-label" for="termsConditionsCheckbox">
        ...
        (<PopupButton
            ...
            />) :
            (
              <button type="button" className='btn btn-outline-info fw-bold' disabled>Submit</button>
            )}
        </div>
      </form>
      <Divider/>
